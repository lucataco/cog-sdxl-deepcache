...
class Predictor(BasePredictor):
    def setup(self) -> None:
        ...
        self.txt2img_pipe.fuse_qkv_projections()
    ...
    def predict(
        ...
        enable_deepcache: bool = Input(
            description="Enable DeepCache",
            default=True
        ),
        ...
        if not enable_deepcache or self.previous_pipe != pipe:
        ...
        if enable_deepcache and (self.previous_pipe != pipe or self.deep_cache is None):
            print("Using DeepCache")
            self.previous_pipe = pipe
        ...
        print("Inference took: ", time.time() - t3)
